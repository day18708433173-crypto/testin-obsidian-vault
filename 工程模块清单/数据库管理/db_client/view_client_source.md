...
客户端来源联合视图。ViewClientInfoDAOImpl 查询使用。ViewClientInfoMapper/MyBatis 操作。
...
-- ----------------------------
-- Table structure for client_info_refresh
-- ----------------------------
DROP TABLE IF EXISTS `client_info_refresh`;
CREATE TABLE `client_info_refresh`  (
                                        ...
                                        `brand_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '电脑品牌',
                                        `action` int(11) NULL DEFAULT NULL COMMENT '动作： 0 空闲; 1 测试; 2真机调试 3 online 4 第三方',
                                        `debug_owner` varchar(64) CHARACTER SET utf8 COLLATE 
-- ... (truncated)
```
